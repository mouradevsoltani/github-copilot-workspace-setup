...
Apply these rules only when the user explicitly asks for a review or when the active agent is a review-focused mode. For implementation tasks, treat this file as non-blocking guidance.
